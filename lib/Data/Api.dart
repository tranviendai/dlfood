...
class APIRepository {
  ...
  Future<String> updateProfile(Signup user, String token) async {
    try {
      final body = FormData.fromMap({
        "numberID": user.numberID,
        "fullName": user.fullName,
  ...
  Future<String> updatePass(String oldPass, String newPass, String token) async {
    try {
      final body = FormData.fromMap({
        "OldPassword": oldPass,
        "NewPassword": newPass,
  ...
  Future<bool> forgotPass(String accountID, String numberID,
  ...
  Future<bool> addBill(List<TempModel> products, String token) async {
    var list = [];
    try {
